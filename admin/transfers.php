<?php 
    ...
    set_headers("Transfers", "transfers");
    include("header.php");
?>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">Transfers</h3>
            ...
            <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
                <div class="float-md-right">
                    <a href="transfer-new.php" class="btn btn-secondary">
                        <i class="fas fa-plus mr-1"></i>Add Transfer
                    </a> 
                </div>   
            </div>
        </div>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard table-responsive">
                                    <table class="table table-light zero-configuration">
                                        ...
                                        <tbody>
                                            <?php 
                                                $execute_query = mysqli_query($link, "SELECT * FROM `transfers` ORDER BY `created_at` DESC");
                                                $line = 0;
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo ucwords(print_var($row["method"])); ?></td> 
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <span class="dropdown">
                                                            ...
                                                            <span class="dropdown-menu dropdown-menu-left">
                                                                ...
                                                                <a href="transfer-status.php?appId=<?php echo $row["id"]; ?>" class="dropdown-item">
                                                                    <i class="fas fa-ban"></i> Approve
                                                                </a>
                                                                <?php } else if ($row["status"] == "approved") { ?>
                                                                <a href="transfer-status.php?rejId=<?php echo $row["id"]; ?>" class="dropdown-item">
                                                                ...
                                                                <a href="transfer-edit.php?transId=<?php echo $row["id"]; ?>" class="dropdown-item">
                                                                    <i class="fas fa-pencil-alt"></i> Edit
                                                                </a>
                                                                <a href="transfer-delete.php?transId=<?php echo $row["id"]; ?>" class="dropdown-item" onclick="return confirm('Are you sure you want to delete this transfer?');">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 col-lg-12">
                                                                        <dl class="row mb-0 redial-line-height-2_5 p-2" style="font-size:15px;">
                                                                            ...
                                                                            <dd class="col-md-7 mb-2"><?php echo print_var($row["swift_code"]); ?></dd>
                                                                            <dt class="col-sm-5">Routing Number:</dt>
                                                                            <dd class="col-md-7 mb-2"><?php echo print_var($row["routing_no"]); ?></dd>
                                                                            <dt class="col-sm-5">Transaction Type:</dt>
                                                                            <dd class="col-md-7 mb-2 uppercase"><?php echo print_var("transfer"); ?></dd>
                                                                            <dt class="col-sm-5">Country:</dt>
                                                                            <dd class="col-md-7 mb-2"><?php echo ucwords(print_var($row["country"])); ?></dd>
                                                                            <dt class="col-sm-5">Payment Method:</dt>
                                                                            <dd class="col-md-7 mb-2 uppercase"><?php echo print_var($row["method"]); ?></dd>
                                                                            ...
                                                                            <dd class="col-sm-7 mb-2"><?php echo print_var($row["narration"]); ?></dd>
