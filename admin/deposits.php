    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">Deposits</h3>
            ...
            <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
                <div class="float-md-right">
                    <a href="deposit-new.php" class="btn btn-secondary">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard table-responsive">
                                    <table class="table table-light zero-configuration">
                                        ...
                                        <tbody>
                                            <?php 
                                                $execute_query = mysqli_query($link, "SELECT * FROM `deposits` ORDER BY `created_at` DESC");
                                                $line = 0;
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <span class="dropdown">
                                                            ...
                                                            <span class="dropdown-menu dropdown-menu-left">
                                                                ...
                                                                <a href="deposit-status.php?appId=<?php echo $row["id"]; ?>" class="dropdown-item">
                                                                    <i class="fas fa-ban"></i> Approve
                                                                </a>
                                                                <?php } else if ($row["status"] == "approved") { ?>
                                                                <a href="deposit-status.php?rejId=<?php echo $row["id"]; ?>" class="dropdown-item">
                                                                ...
                                                                <a href="deposit-edit.php?dId=<?php echo $row["id"]; ?>" class="dropdown-item">
                                                                    <i class="fas fa-pencil-alt"></i> Edit
                                                                </a>
                                                                <a href="deposit-delete.php?dId=<?php echo $row["id"]; ?>" class="dropdown-item" onclick="return confirm('Are you sure you want to delete this deposit?');">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 col-lg-12">
                                                                        <dl class="row mb-0 redial-line-height-2_5 p-2" style="font-size:15px;">
                                                                            ...
                                                                            <dt class="col-md-5">Transaction Type:</dt>
                                                                            <dd class="col-md-7 mb-2 uppercase"><?php echo print_var("deposit"); ?></dd>
                                                                            <dt class="col-md-5">Payment Method:</dt>
                                                                            ...
                                                                            <dd class="col-md-7 mb-2"><?php echo print_currency($row["charge"], "usd"); ?></dd>
                                                                            <dt class="col-md-5">After Balance:</dt>
                                                                            <dd class="col-md-7 mb-2"><?php echo print_currency($row["after_balance"], $row["currency"]); ?></dd>
