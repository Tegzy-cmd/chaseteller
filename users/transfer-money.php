<?php 
    ...
    $_SESSION["dashboard_title"] = "Transfer Money";
...
?>
  ...
  <div id="content" class="py-4">
    ...
    <div class="container">
      ...
      <p class="text-4 text-center mb-4">Transfer money anytime, anywhere in the world.</p>
      <div class="row">
        <div class="col-md-8 col-lg-6 col-xl-5 mx-auto">
          <div class="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
            <!-- Send Money Form
            ============================================= -->
            <form id="form-send-money" action="transfer-money-confirm.php" method="post">
              <input type="hidden" name="trnx_id" value="<?php echo strtoupper(generate_reference(18)); ?>">
              <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
              
              <div class="form-group">
                <label for="bank">Bank Name</label>
                <input type="text" class="form-control" data-bv-field="bank" id="bank" name="bank" required placeholder="Enter the Bank Name">
              </div>
              <div class="form-group">
                <label for="account_name">Account Name</label>
                <input type="text" class="form-control" data-bv-field="account_name" id="account_name" name="account_name" required placeholder="Enter the Account Name">
              </div>
              <div class="form-group">
                <label for="account_no">Account Number</label>
                <input type="text" class="form-control" data-bv-field="account_no" id="account_no" name="account_no" required placeholder="Enter the Account Number">
              </div>
              <div class="form-group">
                <label for="swift_code">Swift Code</label>
                <input type="text" class="form-control" data-bv-field="swift_code" id="swift_code" name="swift_code" required placeholder="Enter the Swift Code">
              </div>
              <div class="form-group">
                <label for="routing_no">Routing Number</label>
                <input type="text" class="form-control" data-bv-field="routing_no" id="routing_no" name="routing_no" required placeholder="Enter the Routing Number">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="amount" required name="amount" placeholder="Enter Amount to Transfer">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="4" id="description" name="description" required placeholder="Payment Description"></textarea>
              </div>
