<?php 
    ...
    $_SESSION["dashboard_title"] = "Withdraw Successful";
        ...
        <div class="col-md-8 col-lg-6 col-xl-5 mx-auto">
          <div class="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
            ...
            <p class="text-center text-3 mb-4">
              Your withdrawal was successfully.<br>See transaction details under 
              <a href="transactions.php">Activity</a>.
            </p>
            <a href="withdraw-money.php" class="btn btn-primary btn-block">Withdraw Money Again</a>
          </div>
        </div>
      </div>
    </div>
