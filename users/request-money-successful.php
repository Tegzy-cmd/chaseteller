<?php 
    ...
    $_SESSION["dashboard_title"] = "Request Successful";
      ...
      <div class="row">
        <div class="col-md-8 col-lg-6 col-xl-5 mx-auto">
            ...
            <p class="text-center text-3 mb-4">
              Your request was successfully.<br> See transaction details under 
              <a href="transactions.php">Activity</a>.
            </p>
            <a href="request-money.php" class="btn btn-primary btn-block">Request Money Again</a>
          </div>
        </div>
      </div>
    </div>
