<?php 
    ...
    $_SESSION["dashboard_title"] = "Withdraw Money";
...
?>
  ...
  <div id="content" class="py-4">
    ...
    <div class="container">
      <h2 class="font-weight-400 text-center mt-3">Withdraw Money</h2>
      <p class="text-4 text-center mb-4">Withdraw your money to your bank account.</p>
      <div class="row">
        <div class="col-md-8 col-lg-6 col-xl-5 mx-auto">
          <div class="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
            <!-- Withdraw Money Form
            ============================================= -->
            <form id="form-send-money" action="withdraw-money-confirm.php" method="post">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" name="amount" required placeholder="Enter Amount to Withdraw">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="4" id="description" name="description" required placeholder="Withdraw Description"></textarea>
              </div>
