<?php 
    ...
    $_SESSION["dashboard_title"] = "Transfer Successful";
...
?>
  ...
  <div id="content" class="py-4">
    <div class="container">
      <h2 class="font-weight-400 text-center mt-3 mb-4">Transfer Money</h2>
      <div class="row">
        <div class="col-md-8 col-lg-6 col-xl-5 mx-auto">
            ...
            <p class="text-center text-3 mb-4">
              Your transfer was successfully.<br>See transaction details under
              <a href="transactions.php">Activity</a>.
            </p>
            <a href="transfer-money.php" class="btn btn-primary btn-block">Transfer Money Again</a>
          </div>
        </div>
      </div>
    </div>
