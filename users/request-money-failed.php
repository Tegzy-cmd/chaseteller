<?php 
    ...
    $_SESSION["dashboard_title"] = "Request Failed";
        ...
        <div class="col-md-8 col-lg-6 col-xl-5 mx-auto">
          <div class="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
            ...
            <p class="text-center text-3 mb-4">
              ...
              Please contact <a href="mailto:contact@chasetellerbank.com" class="text-success font-weight-500">contact@chasetellerbank.com</a> for more information.
            </p>
          </div>
        </div>
      </div>
